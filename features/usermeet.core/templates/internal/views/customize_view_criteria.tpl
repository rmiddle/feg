...
<tr>
	<td width="0%" nowrap="nowrap" valign="top">
		...
		<button type="button" onclick="this.form.a.value='viewAddFilter';genericAjaxPost('customize{$view->id}','viewCustomFilters{$view->id}','c=internal');"><img src="{devblocks_url}c=resource&p=usermeet.core&f=images/data_error.gif{/devblocks_url}" align="top"> Delete</button>
		</div>
	</td>
	<td valign="top" width="100%">
		<div class="block" style="width:98%;">
			...
			<button type="button" onclick="this.form.a.value='viewAddFilter';genericAjaxPost('customize{$view->id}','viewCustomFilters{$view->id}','c=internal');"><img src="{devblocks_url}c=resource&p=usermeet.core&f=images/data_new.gif{/devblocks_url}" align="top"> Add Filter</button>
		</div>		
	</td>
</tr>
</table>
