...
<H1>Welcome to Usermeet!</H1>
<br>

{*
<div style="width:650px;margin:5px;padding:5px;border:2px solid rgb(200,200,200);">
<img src="{devblocks_url}c=resource&p=usermeet.core&f=images/wgm/c4_overview.jpg{/devblocks_url}"><br>
...
<div class="block">
	...
	<ul style="list-style:square;">
		<li><p>The people ... <b>workers</b>.</p></li>
		<li><p>A <b>sensor</b> ..</p></li>
	</ul>
</div>
<br>
...
<form>
	<button type="button" onclick="document.location.href='{devblocks_url}c=preferences{/devblocks_url}';"><img src="{devblocks_url}c=resource&p=usermeet.core&f=images/check.gif{/devblocks_url}" align="top"> Let's set up your account!</button>
</form>