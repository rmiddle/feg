...
<div id="setupTabs">
	<ul>
		...
		<li><a href="{devblocks_url}ajax.php?c=setup&a=showTabImport&request={$request_path|escape:'url'}{/devblocks_url}">{$translate->_('setup.tab.customer_recipient')|escape:'quotes'}</a></li>
