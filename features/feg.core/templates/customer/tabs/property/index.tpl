...
<table cellpadding="0" cellspacing="2" border="0" width="98%">
	<tr>
		...
		<td width="100%"><input type="text" name="customer_account_number" value="{if isset($account_number) && ($customer->import_source == 0)}{$account_number}{else}{$customer->account_number|escape}{/if}" style="width:98%;"></td>
	</tr>
	<tr>
