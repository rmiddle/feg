...
<div class="block">
	...
	<div id="saveCriteria_{$view->id}" style="display:none;"><br><button type="submit"><img src="{devblocks_url}c=resource&p=feg.core&f=images/check.gif{/devblocks_url}" align="top"> {$translate->_('common.save_changes')|capitalize}</button></div>
